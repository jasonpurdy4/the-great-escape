  ...
  try {
    ...
    const request = {
      body: {
        ...
        applicationContext: {
          returnUrl: `${process.env.FRONTEND_URL || 'https://www.thegreatescape.app'}/payment/success`,
          cancelUrl: `${process.env.FRONTEND_URL || 'https://www.thegreatescape.app'}/payment/cancel`,
